...
from phone_video_sync.report.format import format_bytes
from phone_video_sync.report.recommend import sort_recommended
from phone_video_sync.report.types import ScanBreakdown
...
def save_scan_report(
    ...
    *,
    ...
    if breakdown.recommended:
        ...
        _write_recommended_csv(csv_path, breakdown, output_suffix=output_suffix)
        lines.extend(
            [
                "",
